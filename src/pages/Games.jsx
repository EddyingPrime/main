...
export default function Games() {
  ...
  return (
    <>
      <NavBar />
      <div className="tablet:mx-20 my-20 , phone:px-3">
          ...
          <div className="col-span-4 m-6">
            ...
            >
              {currentCards.map((game, index) => (
                <div
                  key={index}
                  className="p-2 bg-white rounded drop-shadow-xl card "
                >
                  <img
                    src={game.thumbnail}
                    alt={`Game ${index + 1}`}
                  ...
                  <div className=" mt-2 flex gap-1">
                    <span className=" m-0 p-1  rounded-lg text-xs border-[0.01rem] border-accent  px-2 text-dark text-[10px] font-Titilium items-center">
                      {game.genre}
                    </span>
                    <span className="m-0 p-1  rounded-lg text-xs border-[0.01rem] border-accent  px-2 text-dark text-[10px] font-Titilium items-center">
                      {game.platform}
