      ...
      <footer>
        ...
        >
          ...
          >
            <div>
              <h3
                className="flex justify-center text-accent font-Bruno text-[40px] py-1
              desktop:text-[50px] desktop:px-10 desktop:pt-10"
              >
                GameHaven
              </h3>
              <p className="text-default font-Titilium text-center text-lg px-10 pb-6">
                <em>
                  " Your one-stop hub for updates, free game list across
                  platforms, and engaging gaming forums - where gamers unite. "
                </em>
              </p>
            </div>
            <div className="flex justify-around">
              <div className="text-center">
                <h3 className="text-accent">
                  Explore more games on your preferred platform:
                </h3>
                <ul
          ...
          <div className="flex items-center justify-center">
            <div className="rounded px-8 pt-6 mb-4">
              <h2 className="text-2xl text-default font-bold mb-4">
                Contact Us
              </h2>
              <form
                className="
              ...
              >
                ...
                <div>
                  <div className="mb-2">
                    ...
                    <textarea
                      className="border rounded py-2 px-3 leading-tight focus:outline-none focus:shadow-outline w-[300px]"
                      id="message"
                      rows="5"
              ...
              <div className="flex items-center justify-between">
                <button
                  className="bg-dark w-full text-white hover:bg-accent hover:text-dark font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                  type="button"
                >
                  Send
                </button>
        ...
        >
          <div className="text-sm w-full">
            All Rights Reserved &copy; GameHaven 2023
          </div>
          <div className="p-2 w-full">
            <ul className="flex justify-center gap-4 text-default text-lg font-BrunoSC text-md h-9 , tablet:gap-4 tablet:pb-0 tablet:pt-2 , desktop:gap-14">
              <li className="hover:border-b-2 hover:border-b-accent">
                <Link to="/">Home</Link>
              </li>
              <li className="hover:border-b-2 hover:border-b-accent">
